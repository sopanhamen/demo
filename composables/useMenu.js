    ...
    return [
        ...
        subItems: [
          {
            ...
            link: propertyLink(ListingPurpose.RENT, PropertyTypeGroup.HOMES),
          ...
          },
          {
            ...
            link: propertyLink(ListingPurpose.RENT, PropertyTypeGroup.BUSINESS),
            listingPurpose: ListingPurpose.RENT,
      ...
      },
      {
        ...
        subItems: [
          {
            title: 'property_type_group.model.homes',
            link: propertyLink(ListingPurpose.SALE, PropertyTypeGroup.HOMES),
          ...
          {
            title: 'property_type_group.model.business',
            link: propertyLink(ListingPurpose.SALE, PropertyTypeGroup.BUSINESS),
            listingPurpose: ListingPurpose.SALE,
            propertyTypeGroup: PropertyTypeGroup.BUSINESS,
            amount: 0
          },
    ...
    return [
      {
        title: '',
        menus: [
          { title: 'dashboard', link: '/admin/dashboard', icon: 'fa fa-tv' }
        ]
      },
      {
        title: 'properties',
          ...
          },
          {
            ...
            submenus: [
              ...
              },
              {
                ...
                icon: 'fa fa-location-dot',
                permissions: [Permission.VIEW_ANY_COMPANY_BRANCH]
              }
            ]
          },
          {
