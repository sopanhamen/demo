<template>
  <div
    ...
    class="w-full lg:p-0 sm:p-4 p-4"
  >
      ...
      <div class="w-full sm:flex sm:space-x-5">
        <div class="flex-auto">
          <admin-form-location
            ...
            :input-class="[
              'text-sm pt-1 pb-1 px-3 min-w-20 shadow-sm',
              roundSize
            ]"
        ...
        <div class="flex-1">
          <button
            class="w-28 min-w-full mt-6 text-sm text-center px-4 py-4 bg-primary text-white shadow-md"
            :class="roundSize"
...
export default {
  ...
  setup() {
    const { roundSize, styleList } = useTheme()
