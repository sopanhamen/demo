    ...
    't-alert': {
        ...
        props: {
            fixedClasses: {
                ...
                body: 'flex-grow',
                close: 'relative flex items-center justify-center ml-4 flex-shrink-0 w-6 h-6 transition duration-100 ease-in-out rounded  focus:ring-2 focus:ring-blue-500 focus:outline-none focus:ring-opacity-50',
                closeIcon: 'fill-current h-4 w-4'
            },
            classes: {
    ...
    't-table': {
        ...
        props: {
            classes: {
                ...
                theadTr: '',
                theadTh:
                    'px-3 py-2 font-semibold text-left bg-gray-100 border-b',
        ...
        props: {
            ...
            classes: {
                ...
                calendarDaysDayWrapper:
                    'w-full h-8 flex flex-shrink-0 items-center',
                otherMonthDay:
    ...
    't-dropdown': {
        ...
        props: {
            fixedClasses: {
                ...
                dropdownWrapper: 'relative z-10',
                dropdown:
                    'origin-top-left absolute left-0 w-56 rounded shadow mt-1',
                enterClass: 'opacity-0 scale-95',
                enterActiveClass: 'transition transform ease-out duration-100',
                enterToClass: 'opacity-100 scale-100',
                leaveClass: 'opacity-100 scale-100',
